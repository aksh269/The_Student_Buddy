...
[Application Process](https://www.daiict.ac.in/admissions#tab-1) DAU's **B.Tech. in Computer Science and Artificial Intelligence (CSAI)** is a four-year undergraduate program designed for students who want strong foundations in Computer Science together with modern Artificial Intelligence. Computing systems now drive innovation across technological sectors, and AI increasingly enables pattern discovery, prediction, and decision-making across domains such as vision, speech, natural language processing, robotics, healthcare, business, and finance.

# Main Content

[Application Process](https://www.daiict.ac.in/admissions#tab-1)

- [displayNone Program Overview](https://www.daiict.ac.in/btech-csai#tab-1)
- [displayNone Program Structure](https://www.daiict.ac.in/btech-csai#tab-2)
