...
type: study_program
title: logo
description: "[Application Process](https://www.daiict.ac.in/admissions#tab-1) DAU\u2019\
  s **B.Tech. in ICT (Hons) with minor in Computational Science (ICT-CS)** is a ..."
source: data/daiict_document/programs_of_study/undergraduate_programs/b_tech_honours_in_ict_with_minor_in_computational_science.md
tags:
- study-program
- programs_of_study
...
[Application Process](https://www.daiict.ac.in/admissions#tab-1) DAU’s **B.Tech. in ICT (Hons) with minor in Computational Science (ICT-CS)** is a four-year undergraduate program designed for students who wish to combine strong foundations in Information and Communication Technology (ICT) with the power of computational and scientific problem solving. As modern science, engineering, industry, and society increasingly rely on data-driven modelling, simulation, optimization, and high-performance computing, computational science has emerged as a key interdisciplinary field connecting computing, mathematics, and real-world applications.

# Main Content

[Application Process](https://www.daiict.ac.in/admissions#tab-1)

- [displayNone Program Overview](https://www.daiict.ac.in/btech-honours-ict-minor-computational-science#tab-1)
- [displayNone Program Structure](https://www.daiict.ac.in/btech-honours-ict-minor-computational-science#tab-2)
