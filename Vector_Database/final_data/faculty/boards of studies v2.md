...
description: '| Name | |------| | **Prof. Bhaskar Chaudhury** - *Chairman*<br>Dean
  (Academic Programs), DA-IICT (ex-Officio) |'
source: data/daiict_document/faculty/boards_of_studies_v2.md
tags:
- faculty
- faculty-profile
